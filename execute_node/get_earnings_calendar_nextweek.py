...
async def scrape_us_events():
    async with async_playwright() as p:
        ...
        # 'Next Week' 클릭 전 기존 Today 테이블 강제 청소 (레이스 컨디션 방지 트릭)
        Next_Week_selector = "button:has(span:text('Next Week')), button:has-text('Next Week')"
        ...
        # print("✅ 'Next Week' 필터 클릭 완료. 주간 데이터 로딩을 대기합니다.")
...
#     output_filename = "us_earnings_next_week.json"
