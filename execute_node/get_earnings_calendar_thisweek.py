...
async def scrape_us_events():
    async with async_playwright() as p:
        ...
        # 'This Week' 클릭 전 기존 Today 테이블 강제 청소 (레이스 컨디션 방지 트릭)
        This_Week_selector = "button:has(span:text('This Week')), button:has-text('This Week')"
        await page.wait_for_selector(This_Week_selector, timeout=15000)
        ...
        await page.click(This_Week_selector)
        # print("✅ 'This Week' 필터 클릭 완료. 주간 데이터 로딩을 대기합니다.")
...
#     output_filename = "us_earnings_this_week.json"
